        ...
        <section className="px-6 md:px-12 py-20 max-w-[1100px] mx-auto">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
            ...
            <div className="text-body text-text-muted leading-relaxed">
              <p>Resident Chef Jill Vedaa leads our 100% gluten-free kitchen with a passion for ingredient-driven cuisine — sourcing every plate from a small circle of Illinois farms and producers.</p>
            </div>
          </div>
        </section>
