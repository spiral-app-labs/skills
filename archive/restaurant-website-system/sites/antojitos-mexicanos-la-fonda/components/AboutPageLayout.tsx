  ...
  return (
    <main className="bg-canvas">
      ...
      <section className="max-w-content mx-auto px-5 md:px-10 pb-16 grid grid-cols-2 md:grid-cols-4 gap-6">
        {a.stats.map((s) => (
          <div key={s.label} className="rounded-card border border-card-border bg-canvas-warm p-6 text-center">
            <div className="text-[44px] leading-[52px] font-extrabold text-accent">{s.value}</div>
