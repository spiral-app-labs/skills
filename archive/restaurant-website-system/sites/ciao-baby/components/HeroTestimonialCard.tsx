// HeroTestimonialCard — pull-quote + review body + sourced proof label + dual
// CTA, overlaid bottom-left on hero photography. Moves the conversion floor up
// into the hero without publishing unsourced aggregate ratings.
'use client';
