  ...
  return (
    <main className="bg-canvas">
      ...
      <section className="max-w-content mx-auto px-5 md:px-10 pb-16 md:pb-24">
        <h2 className="text-section-h2 font-extrabold text-ink">Five Rooms for Private Events</h2>
        <p className="mt-3 max-w-[640px] text-body text-ink-soft">
          From 25 to 110 guests. Full-service bar in every room. Available 7 days a week starting at 11 AM.
        </p>
        <div className="mt-8 grid grid-cols-2 md:grid-cols-5 gap-3 md:gap-4">
          {content.rooms.tiles.map((t) => (
        ...
        <div className="mt-10">
          <NumberedAccordion rows={content.rooms.accordion} />
        </div>
      </section>
    </main>
  );
