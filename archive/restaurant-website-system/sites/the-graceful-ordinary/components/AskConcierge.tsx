...
function MapCard() {
  ...
  return (
    <div className="overflow-hidden rounded-card border border-border/60 bg-surface">
      <iframe
        src={src}
        title="The Graceful Ordinary location"
...
function ReserveButton({
  ...
  const handleClick = useCallback(async () => {
    ...
    onToast(
      ok
        ? 'Special request copied, paste it in the notes field on Resy.'
        : 'Mention your special request in the Resy notes field.',
    );
  }, [special, onToast]);
...
export function AskConcierge() {
  ...
  return (
    <>
      ...
      <button
        type="button"
        aria-label="Ask The Graceful Ordinary"
      ...
      >
        ...
        <span className="italic">Graceful</span>
      </button>
      ...
      >
        ...
        <div
          role="dialog"
          aria-label="The Graceful Ordinary concierge"
            ...
            {messages.length === 0 && (
              <div className="space-y-3">
                <p className="font-display text-section-h2 leading-[1.1] text-text">
                  ...
                  <span className="italic">Graceful Ordinary.</span>
                </p>
                <p className="text-body-sm text-text-muted">
                  Ask about the menu, the room, the wine list, or a table for
                  tonight.
                </p>
              </div>
            )}
          ...
          >
            <div className="flex items-center gap-2">
              <input
                ...
                placeholder="Ask Graceful Ordinary…"
                disabled={streaming}
            ...
            <p className="mt-2 text-[11px] leading-tight text-text-subtle">
              AI concierge, for allergy, dietary, or large-party questions, please call{' '}
              {content.brand.phone}.
            </p>
          </form>
