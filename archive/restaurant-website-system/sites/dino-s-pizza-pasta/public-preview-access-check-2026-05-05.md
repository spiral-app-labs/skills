...
- Evidence: unauthenticated `curl -I -L` returned `HTTP/2 401` again at 2026-05-06T04:41:40Z from Vercel with `Authentication Required` HTML and `_vercel_sso_nonce` cookie.
