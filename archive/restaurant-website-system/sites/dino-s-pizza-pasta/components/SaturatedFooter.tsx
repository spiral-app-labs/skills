        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-12">
          <div className="md:col-span-1">
            ...
            <div className="mt-4 text-body-sm opacity-95">
              <div>
                <a href={content.brand.phoneHref} className="inline-flex min-h-10 items-center hover:underline">
                  {content.brand.phone}
                </a>
              </div>
              <div>
                <a href={`mailto:${content.brand.email}`} className="inline-flex min-h-10 items-center hover:underline">
                  {content.brand.email}
                </a>
              </div>
            </div>
              ...
              <ul className="mt-4 space-y-2">
                {col.links.map((link) => (
                  <li key={link.label}>
                    <a
                      href={link.href}
                      className="inline-flex min-h-10 min-w-10 items-center text-body-sm opacity-95 hover:opacity-100 hover:underline"
                    >
                      {link.label}
                    </a>
                  </li>
