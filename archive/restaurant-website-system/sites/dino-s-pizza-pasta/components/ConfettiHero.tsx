...
export function ConfettiHero() {
  return (
    <section className="relative overflow-hidden bg-canvas">
      <div className="max-w-content mx-auto px-5 md:px-10 pt-10 md:pt-24 pb-8 md:pb-16">
        <div className="relative z-10 text-center max-w-[900px] mx-auto">
          ...
          <motion.h1
            ...
            className="mt-3 md:mt-4 text-[38px] leading-[42px] tracking-[-0.5px] md:text-hero-h1 font-extrabold text-ink"
          >
          ...
          <motion.p
            ...
            className="mt-4 md:mt-5 text-body-sm md:text-body text-ink-soft max-w-[340px] md:max-w-[560px] mx-auto"
          >
        ...
        <motion.div
          ...
          className="relative z-10 mt-8 md:mt-16 mx-auto max-w-[720px]"
        >
          <div className="rounded-[48px] border border-card-border bg-canvas-warm p-8 shadow-card">
            <div className="grid gap-4 md:grid-cols-[1.3fr_0.7fr]">
              <div className="rounded-[36px] bg-accent p-8 text-text-on-brand">
                <p className="text-eyebrow font-bold uppercase">Tonight at Dino&apos;s</p>
                <ul className="mt-4 space-y-3 text-body">
                  <li>Made-from-scratch thin crust is the house signature.</li>
                  <li>Stuffed deep dish, pan pizza, and double dough cover the rest of the table.</li>
                  <li>Pasta dinners, slices, and garlic bread sandwiches keep the menu from feeling narrow.</li>
                </ul>
              </div>
              <div className="rounded-[36px] bg-ink p-8 text-text-on-dark">
                <p className="text-eyebrow font-bold uppercase text-accent">Hours</p>
                <div className="mt-4 space-y-2 text-body-sm">
                  {content.brand.hours.slice(2).map((row) => (
                  ...
                  <div className="pt-2 text-body-sm opacity-80">Closed Monday and Tuesday.</div>
                </div>
              </div>
            </div>
          </div>
