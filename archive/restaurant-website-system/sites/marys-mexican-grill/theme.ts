...
//
// FIRST SATURATED-ACCENT TEMPLATE IN THE CATALOG. The orange (#DD5903) does
...
export const theme = {
  ...
  color: {
    // SECTION BACKGROUNDS
    bgDark:        '#1A0F0B', // hero, page headers, testimonial, footer — warm chile-brown
    bgCream:       '#F6EBDD', // content sections
    bgWhite:       '#FFFFFF', // cards, form fields
    // BRAND ACCENT — single color, relentless
    accent:        '#C84A1B', // CTA fills, eyebrow dots, timeline nodes, star ratings, icons
    accentSoft:    'rgba(200, 74, 27, 0.12)', // tint for subtle accent bg (eyebrow chips, hover)
    // TEXT
    textDark:      '#21130E', // on cream/white
    textWhite:     '#FFFFFF', // on dark
    textMuted:     '#735F54', // muted body on cream/white
    textMutedDark: '#D5C3B7', // muted body on dark
    // BORDERS
    borderLight:   '#E9D9C8', // on cream — card borders, menu row dividers
    borderDark:    '#2D1B15', // on dark — subtle separators
    dotLeader:     '#D3BEA9', // the dotted leader in menu rows
  },
