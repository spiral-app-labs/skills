...
function ReserveButton({
  ...
  const handleClick = useCallback(async () => {
    ...
    onToast(
      ok
        ? 'Special request copied. Mention it when you call.'
        : 'Mention your special request when you call.',
    );
  }, [special, onToast]);
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      >
        {content.reservationStrip.primaryCta.label}
...
export function AskConcierge() {
  ...
  return (
    <>
      ...
      <button
        type="button"
        aria-label={`Ask ${content.brand.name}`}
      ...
      >
        ...
        <span className="italic">Addison's</span>
      </button>
      ...
      >
        ...
        <div
          role="dialog"
          aria-label={`${content.brand.name} concierge`}
            ...
            {messages.length === 0 && (
              <div className="space-y-3">
                ...
                <p className="text-body-sm text-text-muted">
                  Ask about the menu, the kitchen, the bar, or a table for
                  tonight.
                </p>
              </div>
            )}
