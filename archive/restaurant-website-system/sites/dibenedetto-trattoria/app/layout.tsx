...
export const metadata: Metadata = {
  metadataBase: new URL('https://dibenedettotrattoria.com'),
    ...
    images: [
      {
        ...
        width: 1000,
        height: 500,
        alt: 'DiBenedetto Trattoria dining room',
      },
    ],
  },
};
...
const menuJsonLd = {
  ...
  '@type': 'Menu',
  '@id': 'https://dibenedettotrattoria.com/menu#menu',
...
const restaurantJsonLd = {
  ...
  url: 'https://dibenedettotrattoria.com/',
  ...
  hasMenu: { '@id': 'https://dibenedettotrattoria.com/menu#menu' },
  priceRange: '$$',
