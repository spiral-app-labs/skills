// Concierge \u2014 floating AI host for DiBenedetto Trattoria.
//
...
const GREETING: Message = {
  role: 'assistant',
  content:
    'Hi \u2014 welcome to DiBenedetto Trattoria. Ask me about the menu, hours, reservations, or catering. I\u2019ll point you in the right direction.',
};
    ...
    <AnimatePresence mode="wait" initial={false}>
      {!open ? (
        <motion.button
          key="launcher"
          type="button"
          aria-label="Open DiBenedetto Trattoria concierge"
        ...
        <motion.div
          key="dialog"
          role="dialog"
          aria-label="DiBenedetto Trattoria concierge"
        ...
        >
          ...
          <p className="border-t border-divider px-5 py-2 font-body text-stamp uppercase tracking-[0.12em] text-ink-quiet">
            Replies are AI-generated. Confirm anything time-sensitive at (847) 496-5016.
          </p>
        </motion.div>
      )}
    </AnimatePresence>
