...
// 3-up blog/news strip. Audit §7 warns: don't ship this if there is
  ...
  return (
    <section className="max-w-plate mx-auto px-5 md:px-10 py-16 md:py-24">
      <div className="flex items-end justify-between mb-8 md:mb-10">
        ...
        <Link href={cta.href} className="hidden md:inline text-button text-accent hover:text-accent-dark">
          {cta.label} →
        </Link>
      </div>
