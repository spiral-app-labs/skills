...
## Prospect Secret Sauce - Vine & Plate

- Owner/site claim: Vine & Plate is a Crystal Lake wine bar + provisions shop with globally inspired shared plates, by-the-glass pours, bottle nights, lunch, specials, Toast ordering, reservations, gift cards, wine dinners, Vine Club, and Off The Vine.
- Review/market-confirmed strengths: pre-visit confidence depends on food, wine, mood, and fit for the night. Public OpenTable proof and existing wine-program surfaces support a preserve-stack pitch, while the PDF menu path weakens discovery.
- Named items or experiences: Wine Glass Wednesday, Half Price Bottle Night, Vine Club, wine dinners, Off The Vine, gift cards, lunch specials, shared plates, Toast ordering, and reservations.
- Guest language worth echoing: "wine bar + provisions," "a glass and a few plates," "bottle night," "next wine dinner," "shared plates," and "the right wine-and-plates night."
- Risks / do-not-overclaim: A fresh Google review packet should still be captured or pasted before owner outreach. Do not claim Wine Spectator unless verified. Treat the OpenTable rating/count as dated to the audit and re-check before a live pitch.
- Website/pitch implications: This is a preserve-stack build, not a teardown. The site should let guests understand the wine/plate mood and choose reserve, Toast, gift cards, wine club, or PDFs from one owned path.
