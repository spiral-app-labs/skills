...
//
// Two modes:
//   - KEYED  - uses Google Maps Embed API with NEXT_PUBLIC_GMAPS_KEY
//   - KEYLESS - uses the legacy Google Maps query-string embed
//
...
export function LiveMapEmbed({
  ...
  const src = apiKey
    ? `https://www.google.com/maps/embed/v1/place?key=${apiKey}&q=${mapQuery}&zoom=${zoom}`
    : `https://maps.google.com/maps?q=${mapQuery}&z=${zoom}&output=embed`;
