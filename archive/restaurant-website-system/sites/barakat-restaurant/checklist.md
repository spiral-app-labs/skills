# barakat-restaurant Build Checklist

- Workflow version: 2026-05-04
- Source of truth: Mission Control tasks.metadata + this mirrored local checklist
- Lead ID: e90facac-3da9-4187-99df-500afac151cf
- MC parent task ID: ff7c934c-1fc1-419e-87d3-e2735bdd7194
- Template slug: bamzi
- Current stage: checklist
- Checklist MD: restaurant-website-system/sites/barakat-restaurant/checklist.md
- Checklist JSON: restaurant-website-system/sites/barakat-restaurant/checklist.json
- Deploy URL: TBD
- Updated: 2026-05-08T04:10:04.725Z
...
- Decision: **Build**
- Recommended register: **Bamzi**
- Evidence: `restaurant-website-system/sites/barakat-restaurant/qualification/lead-fit-qualification-2026-05-08.md`
- Why switch: current official site appears to be a thin Lovable shell while reserve/order/cuisine story exists elsewhere.

## Checklist sync

- Checklist MD: `restaurant-website-system/sites/barakat-restaurant/checklist.md`
- Checklist JSON: `restaurant-website-system/sites/barakat-restaurant/checklist.json`
- Local passed rows: `checklist-md`, `checklist-json`, `checklist-mc-sync`
