...
export function AboutValuesGrid() {
  ...
  return (
    <section className="max-w-plate mx-auto px-5 md:px-10 py-16 md:py-20">
      <h2 className="font-display text-section-h2 font-bold uppercase text-ink text-center mb-10 md:mb-14">
        {heading}
      </h2>
      <div className="grid md:grid-cols-3 gap-10 md:gap-12">
        {items.map((item) => (
          <div key={item.title}>
            <h3 className="font-display text-section-h3 font-bold uppercase text-accent">{item.title}</h3>
