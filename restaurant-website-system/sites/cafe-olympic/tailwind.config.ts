...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'hero-h1':       [`clamp(40px, 9vw, ${t.type.heroH1.size}px)`,    { lineHeight: '1.05', fontWeight: '700' }],
        'section-h2':    [`clamp(32px, 4.5vw, ${t.type.sectionH2.size}px)`, { lineHeight: '1.2',  fontWeight: '500' }],
