...
2. **Contact page rebuilt from scratch.** Source ships a 404-cosplay; this build delivers hero + address/phone/hours + map + direct phone/directions handoffs, with no fake form.
...
5. **Review proof glyph uses warm ochre** (`#C69A4E`) and a sourced proof label instead of an unsourced aggregate rating/count.
