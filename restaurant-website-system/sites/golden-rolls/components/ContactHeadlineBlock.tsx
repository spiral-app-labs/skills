...
export function ContactHeadlineBlock() {
  ...
  return (
    <section className="bg-bg-white py-20 px-6 text-center">
      <button className="mx-auto mb-6 inline-flex h-16 w-16 items-center justify-center rounded-full bg-accent text-text-white text-xl hover:brightness-110 transition" aria-label="Play video">
        ▶
      </button>
