...
export const theme = {
  name: 'bramble-01',
  archetype: 'warm-downtown-smokehouse-with-catering',
  mode: 'light',

  color: {
    // SECTION BACKGROUNDS — template has multiple bg registers per page
    bgCream:       '#F4E8D2', // warm smokehouse cream
    bgDark:        '#18110D', // char and dark wood
    bgWhite:       '#FFFFFF', // browser body bg
    // TEXT
    textDark:      '#19110D', // on cream sections
    textCream:     '#FFF2D2', // on dark sections
    textMuted:     '#6F5946', // muted body on cream sections
    textMutedCream: '#D8C29C', // muted body on dark sections
    // Borders / accents
    borderDark:    '#3A2A20', // on dark bg
    borderCream:   '#2B1B13', // outlined buttons on cream
    polaroidBorder: '#FFFFFF', // white border on polaroids
    overlay:       'rgba(24, 17, 13, 0.25)', // hero scrim for wordmark legibility
    brass:         '#C98A3A',
    sauceRed:      '#8F2418',
    wood:          '#704B32',
  },
