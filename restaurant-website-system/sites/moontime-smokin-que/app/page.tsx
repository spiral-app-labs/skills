...
import { ConversionFloor } from '../components/ConversionFloor';
...
import { ContactStrip } from '../components/SocialStripInline';
  ...
  return (
    <>
      ...
      <main>
        ...
        <HorizontalMarquee text="Order Online - Catering - Menu - Directions - Gift Cards" variant="dark-on-cream" />
        <ScrollRevealScrapbook>
          <OpeningTimesBlock />
        </ScrollRevealScrapbook>
        <ScrollRevealScrapbook>
