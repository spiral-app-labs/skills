// ContactPage — call-first contact page with address, phone, hours, map, and
// a general inquiry form for non-reservation messages.
'use client';
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-12">
        ...
        <div className="md:col-span-5 space-y-6">
          <div className="rounded-card bg-surface p-6 md:p-8">
            ...
            <div className="mt-6">
              <BookATableButton label="Call to Reserve" href={b.reservationUrl} />
            </div>
          </div>
