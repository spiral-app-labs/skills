...
export function FloatingHeaderPill() {
  return (
    <motion.header
      className="fixed top-6 left-4 right-4 sm:left-1/2 sm:right-auto sm:-translate-x-1/2 z-50 flex items-center justify-between sm:justify-start gap-1 rounded-pill bg-surface/95 backdrop-blur-sm border border-border/50 pl-3 pr-1 py-1.5"
