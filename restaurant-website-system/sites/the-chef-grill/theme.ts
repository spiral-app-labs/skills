...
export const theme = {
  ...
  color: {
    // CANVAS
    canvas:       '#FBF6EA', // warm cream / sesame paper — NOT pure white
    canvasAlt:    '#F2E8D5', // toasted sesame surface for cards / forms
    // TEXT
    ink:          '#24201B', // charcoal brown — NOT pure #000
    inkMuted:     '#5E5549', // warm mid-brown for body copy, captions, descriptions
    // ACCENT
    accent:       '#A55F2A', // restrained copper / amber — PRIMARY CTA accent
    accentDark:   '#74431F', // deeper copper for hover
    accentSoft:   '#7A6C3A', // olive accent, used sparingly as support
    // UTILITY
    divider:      '#DDCFB6', // warm hairline divider between menu rows + FAQ rows
