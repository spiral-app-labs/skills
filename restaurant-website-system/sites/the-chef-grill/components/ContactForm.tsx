...
export function ContactForm() {
  ...
  return (
    ...
    >
      ...
      >
        {submitted ? 'Use phone or email to send' : form.submitLabel}
      </button>
      <p className="text-body-sm text-ink-muted">
        {submitted ? 'Please call 3123138900 or email info@thechefgrill.com to contact the restaurant directly.' : form.helper}
      </p>
    </form>
  );
}
