...
export function PageHeroSplit({
  ...
  return (
    <div className="md:flex md:min-h-screen">
      ...
      <div
        className={`relative md:w-[60%] h-[52vh] md:h-screen ${
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(to top, rgba(10,11,10,0.85) 0%, rgba(10,11,10,0.0) 100%)',
          }}
        />

        {/* Page title — animated fade-up */}
        <motion.h1
          className="absolute bottom-8 md:bottom-12 left-6 md:left-10 font-display text-text"
          style={{
