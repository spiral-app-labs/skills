...
export const theme = {
  ...
  color: {
    ...
    bgCream:       '#F1D9A5', // tortilla cream
    bgDark:        '#120B07', // near-black mole
    bgWhite:       '#F7EEE0', // salt white
    // TEXT
    textDark:      '#120B07', // on cream sections
    textCream:     '#F7EEE0', // on dark sections
    textMuted:     '#5D4535', // muted body on cream sections
    textMutedCream: '#D2BE91', // muted body on dark sections
    // Borders / accents
    borderDark:    '#2A140B', // on dark bg
    borderCream:   '#2A140B', // outlined buttons on cream
    polaroidBorder: '#FFFFFF', // white border on polaroids
    overlay:       'rgba(18, 11, 7, 0.25)', // hero scrim for wordmark legibility
  ...
  type: {
    ...
    marqueeItem:   { size: 48,  lineHeight: 56,  tracking: 0,  weight: 300, transform: 'uppercase' },
    button:        { size: 16,  lineHeight: 16,  tracking: 0,  weight: 600, transform: 'none' },   // Inter weight 600
    address:       { size: 12,  lineHeight: 16,  tracking: 0,  weight: 600, transform: 'uppercase' },
