...
export function TopTriptychHeader() {
  return (
    <motion.header
      className="fixed inset-x-0 top-0 z-50 flex h-16 items-center justify-between px-4 text-text-cream md:h-20 md:px-10"
    ...
    >
      <Link
        ...
        className="rounded-button border border-text-cream/60 px-3 py-2 text-button text-text-cream transition-colors hover:bg-text-cream/10 md:px-4"
      >
        Reserve
      </Link>
      ...
      <Link
        href="#menus"
        className="hidden items-center gap-2 rounded-button border border-text-cream/60 px-3 py-2 text-button text-text-cream transition-colors hover:bg-text-cream/10 md:flex md:px-4"
      >
        Menu
