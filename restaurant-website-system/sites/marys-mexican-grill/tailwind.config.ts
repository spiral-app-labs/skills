...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'hero-h1':    [`clamp(40px, 6vw, ${t.type.heroH1.size}px)`, { lineHeight: '1.25' }],
        'section-h2': [`clamp(48px, 8vw, ${t.type.sectionH2.size}px)`, { lineHeight: '1' }],
        'section-h3': [`clamp(32px, 5vw, ${t.type.sectionH3.size}px)`, { lineHeight: '1.2' }],
