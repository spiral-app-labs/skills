  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
        ...
        <Field label={form.fields.website.label} placeholder={form.fields.website.placeholder} />
      ...
      {submitted && (
        <p role="status" className="mt-5 text-body text-ink/75">
          Thanks — this prototype would send the inquiry to Shirley's event team.
        </p>
      )}
    </form>
  );
