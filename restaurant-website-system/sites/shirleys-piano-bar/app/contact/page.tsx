...
// /contact — visit basics + inquiry form + interior strip + FAQ.
            ...
            <aside className="md:col-span-4">
              ...
              <div className="grid grid-cols-2 gap-6 max-w-sm">
                <div>
                  ...
                  <Link href={c.bookNow.viaEmail.href} className="vs-link text-body">{c.bookNow.viaEmail.value}</Link>
                </div>
                <div>
                  <div className="text-micro text-ink/60 mb-1">{c.bookNow.whatsapp.label}</div>
                  <Link href={c.bookNow.whatsapp.href} className="vs-link text-body">{c.bookNow.whatsapp.value}</Link>
                </div>
              </div>
