// theme.ts — Shirley's Piano Bar prospect fork
//
// Based on velvet-shaker-01, warmed away from cool modernist speakeasy toward
// candlelit piano-bar intimacy. The system stays mostly two-token and sans-led,
// with the warmth carried by plum-black canvas, cream ink, and first-party
// venue photography.

export const theme = {
  name: 'shirleys-piano-bar',
  archetype: 'late-night-piano-bar-cocktail-venue',
  mode: 'dark',
